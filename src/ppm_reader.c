...
void init_ppm_reader () {
	...
	TCC0->PERBUF.bit.PERBUF = 50000 - 1;
	TCC0->PER.bit.PER = 50000 - 1;
	// TCC1->CTRLBCLR.bit.DIR = 1;
	// TCC1->CTRLBSET.bit.ONESHOT = 1;
	// TCC1->PERBUF.bit.PERBUF = 50000 - 1;
	// TCC1->PER.bit.PER = 50000 - 1;
	// TCC2->CTRLBCLR.bit.DIR = 1;
	// TCC2->CTRLBSET.bit.ONESHOT = 1;
	// TCC2->PERBUF.bit.PERBUF = 50000 - 1;
	// TCC2->PER.bit.PER = 50000 - 1;
	...
	// TCC1->EVCTRL.reg = TCC_EVCTRL_MCEI0 | TCC_EVCTRL_MCEI1 | TCC_EVCTRL_MCEO0 | TCC_EVCTRL_MCEI1;
	// TCC2->EVCTRL.reg = TCC_EVCTRL_MCEI0 | TCC_EVCTRL_MCEI1 | TCC_EVCTRL_MCEO0 | TCC_EVCTRL_MCEI1;
...
void init_ppm_pin () {
	//PA12 - PA15
	PORT->Group[0].PMUX[6].bit.PMUXE = 0;
	PORT->Group[0].PMUX[6].bit.PMUXO = 0;
	PORT->Group[0].PMUX[7].bit.PMUXE = 0;
	PORT->Group[0].PMUX[7].bit.PMUXO = 0;
